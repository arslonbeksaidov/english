...
$result = $con->query("select * from darslar WHERE id='$new_id'")->fetch_assoc();
if (isset($_POST['submit'])) {
    $dars=$_POST['dars'];
    $okey = $con->query("update darslar set nomi='$dars' WHERE id='$new_id'");
    if ($okey)
        header('location:index.php');
}
?>
    ...
    <section class="content">
      ...
      <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
          ...
          <div class="form-group has-success has-feedback">
              <label class="col-sm-2 control-label" for="inputSuccess"><a href="#">Lesson</a> </label>
              <div class="col-sm-10">
                  <input value="<?= $result['nomi'] ?>" type="text" class="form-control" id="inputSuccess" name="dars">
