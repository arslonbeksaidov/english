      ...
      <?php foreach ($result as $row) { ?>
          <tr>
              ...
              <td>
                  ...
                  <a href="update_users.php?id=<?= $row['id'] ?>"><span class="glyphicon glyphicon-pencil">Update</span></a>
                  <br>
                  <br>
                  ...
                  <a href="view_users.php?id=<?php echo $row['id']?>" class="glyphicon glyphicon-book">
                      View
                  </a>
              </td>
          </tr>
