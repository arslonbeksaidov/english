...
$result = $con->query("select * from darslar");
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="">
        Hello Admin
        <small></small>
          <a class="btn btn-primary btn-lg" href="create_lesson.php">Add Lesson</a>
          <br><br>
      </h1>
      <ol class="breadcrumb">
        ...
        <table class="table table-bordered well">
            ...
            <?php foreach ($result as $row) { ?>
                <tr>
                    ...
                    <td><?= $row['nomi'] ?></td>
                      <td>
                        <a href="update_lesson.php?id=<?= $row['id'] ?>"><span class="glyphicon glyphicon-pencil"></span></a>
                        <a href="delete_lesson.php?act=deletelesson&id=<?= $row['id'] ?>"><span
                                class="glyphicon glyphicon-trash"></span></a>

                    </td>
                    <th><a href="create_questions.php?id=<?= $row['id'] ?>"><span class="glyphicon glyphicon-book"></span></a>
                      <a href="update_questions.php?id=<?= $row['id'] ?>"><span class="glyphicon glyphicon-pencil"></span></a>

                              <a href="view_questions.php?id=<?php echo $row['id']?>" class="glyphicon glyphicon-socket">
                                View
                              </a>
                    </th>
