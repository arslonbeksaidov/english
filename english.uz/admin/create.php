...
if (isset($_POST['submit'])){
    ...
    $upload = __DIR__."../images/news_image/";
    move_uploaded_file($_FILES['file']['tmp_name'], $upload . basename($_FILES['file']['name']));
//    echo $upload . basename($_FILES['file']['name']); exit;
    $maz = $_POST['mavzu'];
    $text = $_POST['texti'];
    $odam = $_POST['odam'];
    ...
    $result = $con->query("insert into news set theme='$maz',image='$rasm',short_info='$text', date='$date1', author='$odam', rubrika_id='$rubrika', number='$number',full_info='$full_info'");
    if ($result)
        header('location:index.php');
}
