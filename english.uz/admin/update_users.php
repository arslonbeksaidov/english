...
$result = $con->query("select * from users WHERE id='$new_id'")->fetch_assoc();
if (isset($_POST['submit'])) {
   ...
   // move_uploaded_file($_FILES['file']['tmp_name'], $upload . basename($_FILES['file']['name']));
    ...
    $role=$_POST['roles'];
    $okey = $con->query("update users set login='$login',name='$name', surname='$surname', tel='$tel', mail='$mail', role='$role' WHERE  id='$new_id'");
    if ($okey)
        header('location:index.php');
}
...
<div class="conteiner">
  ...
  <form class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
    ...
    <div class="form-group has-error has-feedback">
        <label class="col-sm-2 control-label" for="inputError"><a href="#">Role</a></label>
        <div class="col-sm-10">
