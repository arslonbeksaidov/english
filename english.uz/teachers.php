...
<title>English.uz | Teachers</title>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12 page-content">
        ...
        <div class="page_nav">
      <span>You are here:</span> <a href="index.php">Home</a> <span><i class="fa fa-angle-double-right"></i>Teachers</span>
      </div>
      </div>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="300ms">
          <div class="image bottom25">
            <img src="images/teacher/TED-teacher-blackboard-TESL-200408288-001_47-420.jpg" alt="Teachers" class=" border_radius">
            <span class="post">English teacher</span>
          </div>
          <h3>Raximov Temur</h3>
          <p class="bottom20 margin10">Raximov Temur teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="400ms">
          <div class="image bottom25">
            <img src="images/teacher/images.jpg" alt="Teachers" class=" border_radius">
            <span class="post">English teacher</span>
          </div>
          <h3>Amanova Tozagul</h3>
          <p class="bottom20 margin10">Amanova Tozagul teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="500ms">
          <div class="image bottom25">
            <img src="images/teacher/detiuz_big.jpg" alt="Teachers" class=" border_radius">
            <span class="post">English teacher</span>
          </div>
          <h3>Bohadirova Tatyana</h3>
          <p class="bottom20 margin10">Bohadirova Tatyana teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="700ms">
          <div class="image bottom25">
            <img src="images/teacher/Career-in-Teaching1.jpg" alt="Teachers" class=" border_radius">
            <span class="post">English teacher</span>
          </div>
          <h3>Davlatova Sevara</h3>
          <p class="bottom20 margin10">Davlatova Sevara teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="800ms">
          <div class="image bottom25">
            <img src="images/teacher/2591_6172.jpg" alt="Teachers" class=" border_radius">
            <span class="post">English teacher</span>
          </div>
          <h3>Rajabova Xusnora</h3>
          <p class="bottom20 margin10">Rajabova Xusnora teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="900ms">
          <div class="image bottom25">
            <img src="images/teacher/1470986058_398-do-shkolu-02.jpg" alt="Teachers" class=" border_radius">
            <span class="post">Our class</span>
          </div>
          <h3>Our class</h3>
          <p class="bottom20 margin10">Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
      ...
      <div class="col-sm-6 col-md-4">
        <div class="teacher margin_top wow fadeIn" data-wow-delay="1000ms">
          <div class="image bottom25">
            <img src="images/teacher/13781928601.jpg" alt="Teachers" class=" border_radius">
            <span class="post"></span>
          </div>
          <h3>Saidjonava Rohatoy</h3>
          <p class="bottom20 margin10">Saidjonava Rohatoy teaches English language.Our teaching qualifications and courses are widely accepted and valued by employers around the world .They are internationally as the quality standars.</p>
          <ul class="social_icon black bottom5">
            <li><a href="#." class="facebook"><i class="fa fa-facebook"></i></a></li>
            <li><a href="#." class="twitter"><i class="icon-twitter4"></i></a></li>
            <li><a href="#." class="dribble"><i class="icon-dribbble5"></i></a></li>
