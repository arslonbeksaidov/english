...
<title>English.uz | Gallery</title>
...
<section id="gallery" class="padding">
  <div class="container">
    <div class="row">
      <div class="col-sm-5">
        <h2 class="heading heading_space">Our photo Gallery <span class="divider-left"></span></h2>
      </div>
      <div class="col-sm-7">
    ...
    <div id="projects" class="cbp">
      <div class="cbp-item book">
        <img src="images/books/11824122.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/books/11824122.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item course book">
        <img src="images/books/1391188534_raymond-murphy-english-grammar-in-use.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/books/1391188534_raymond-murphy-english-grammar-in-use.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item book">
        ...
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/books/2.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item teacher ">
        ...
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/11.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item teacher">
        <img src="images/student/12.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/12.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item student">
        <img src="images/student/13.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/13.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item event student">
        <img src="images/student/15.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/15.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item event student">
        <img src="images/student/16.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/16.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item student event">
        <img src="images/student/18.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/18.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item teacher">
        <img src="images/student/23.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/23.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item student">
        <img src="images/student/24.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/24.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item teacher">
        <img src="images/student/25.jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/25.jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
      <div class="cbp-item student">
        <img src="images/student/STUDENTS%20(2).jpg" alt="">
        <div class="overlay">
          <div class="centered text-center">
            <a href="images/student/students%20(2).jpg" class="cbp-lightbox opens"> <i class="icon-focus"></i></a>
          </div>
        </div>
      </div>
    </div>
